...
```{r ttest-Bayesian}
n_its <- 1000000  # number of iterations, should this be 1000000?
...
if (save_dat == 'yes'){
 save(res_ttest_d, file = here('data_stats/results_ttest_nhst.Rdata')) 
 save(res_tBF, file = here('data_stats/results_ttest_bf.Rdata'))
 save(results_BF_effsize, file = here('data_stats/results_ttest_eff_bf.Rdata'))
